...
public abstract class SinglePoint3DTriangulator {
     ...
     */
    protected SinglePoint3DTriangulator(final List<Point2D> points2D,
     ...
     */
    public static boolean areValidPointsAndCameras(final List<Point2D> points2D,
                                                   final List<PinholeCamera> cameras) {
     ...
     */
    public static SinglePoint3DTriangulator create(final List<Point2D> points2D,
                                                   final List<PinholeCamera> cameras, double[] weights) {
     ...
     *                                  required to compute triangulation.
     */
    private void internalSetPointsAndCameras(final List<Point2D> points2D,
                                             final List<PinholeCamera> cameras) {
