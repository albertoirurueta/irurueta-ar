...
public class LMSEHomogeneousSinglePoint3DTriangulator extends SinglePoint3DTriangulator {
     ...
     */
    public LMSEHomogeneousSinglePoint3DTriangulator(final List<Point2D> points2D, final List<PinholeCamera> cameras) {
     ...
     *                 class.
     */
    public LMSEHomogeneousSinglePoint3DTriangulator(final SinglePoint3DTriangulatorListener listener) {
        super(listener);
        allowLMSESolution = DEFAULT_ALLOW_LMSE_SOLUTION;
    }
     ...
     *                                  required to compute triangulation.
     */
    public LMSEHomogeneousSinglePoint3DTriangulator(final List<Point2D> points2D,
