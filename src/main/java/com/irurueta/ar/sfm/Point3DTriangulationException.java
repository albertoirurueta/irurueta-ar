...
public class Point3DTriangulationException extends StructureFromMotionException {
     ...
     */
    public Point3DTriangulationException(final String message) {
        super(message);
    }
     ...
     */
    public Point3DTriangulationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause instance containing the cause of the exception.
     */
    public Point3DTriangulationException(final Throwable cause) {
        super(cause);
    }
}
