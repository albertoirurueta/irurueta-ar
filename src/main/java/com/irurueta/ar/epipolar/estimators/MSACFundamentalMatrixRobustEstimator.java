 ...
 */
public class MSACFundamentalMatrixRobustEstimator extends FundamentalMatrixRobustEstimator {
     ...
     *                                  estimator.
     */
    public MSACFundamentalMatrixRobustEstimator(final FundamentalMatrixEstimatorMethod fundMatrixEstimatorMethod) {
     ...
     */
    public MSACFundamentalMatrixRobustEstimator(
            final FundamentalMatrixEstimatorMethod fundMatrixEstimatorMethod, final List<Point2D> leftPoints,
     ...
     *                 estimation starts, ends or its progress significantly changes.
     */
    public MSACFundamentalMatrixRobustEstimator(final FundamentalMatrixRobustEstimatorListener listener) {
     ...
     *                                  the same length or their length is less than 7 points.
     */
    public MSACFundamentalMatrixRobustEstimator(final List<Point2D> leftPoints, final List<Point2D> rightPoints) {
    ...
    public FundamentalMatrix estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<FundamentalMatrix>(new MSACRobustEstimatorListener<>() {
            ...
            public void onEstimateStart(final RobustEstimator<FundamentalMatrix> estimator) {
                if (listener != null) {
                    listener.onEstimateStart(MSACFundamentalMatrixRobustEstimator.this);
                }
            }
            ...
            public void onEstimateEnd(final RobustEstimator<FundamentalMatrix> estimator) {
                if (listener != null) {
                    listener.onEstimateEnd(MSACFundamentalMatrixRobustEstimator.this);
                }
            }
            ...
            public void onEstimateNextIteration(
                ...
                if (listener != null) {
                    listener.onEstimateNextIteration(MSACFundamentalMatrixRobustEstimator.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(
                ...
                if (listener != null) {
                    listener.onEstimateProgressChange(MSACFundamentalMatrixRobustEstimator.this, progress);
                }
            }
        });
