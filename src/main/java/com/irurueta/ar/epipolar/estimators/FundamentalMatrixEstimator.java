...
public abstract class FundamentalMatrixEstimator {
     ...
     */
    protected FundamentalMatrixEstimator(final List<Point2D> leftPoints,
     ...
     */
    public void setListener(final FundamentalMatrixEstimatorListener listener)
            throws LockedException {
        if (isLocked()) {
            throw new LockedException();
        }
     ...
     *                                  have the same length.
     */
    public static FundamentalMatrixEstimator create(final List<Point2D> leftPoints,
                                                    final List<Point2D> rightPoints) {
