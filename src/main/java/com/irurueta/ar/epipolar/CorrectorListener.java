...
public interface CorrectorListener {
     ...
     */
    void onCorrectStart(final Corrector corrector);
     ...
     * @param corrector instance that generated the event.
     */
    void onCorrectEnd(final Corrector corrector);
     ...
     */
    void onCorrectProgressChange(final Corrector corrector, final float progress);
}
