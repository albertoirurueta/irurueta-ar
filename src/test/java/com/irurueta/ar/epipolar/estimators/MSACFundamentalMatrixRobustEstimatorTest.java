...
class MSACFundamentalMatrixRobustEstimatorTest implements FundamentalMatrixRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new MSACFundamentalMatrixRobustEstimator();

        // check correctness
        assertEquals(MSACFundamentalMatrixRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(emptyPoints, rightPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(leftPoints, emptyPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(emptyPoints, rightPoints, this));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(leftPoints, emptyPoints, this));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints, this));
    }

    @Test
    void testGetSetNonRobustFundamentalMatrixEstimatorMethod() throws LockedException {
        final var estimator = new MSACFundamentalMatrixRobustEstimator();
    ...
    void testEstimateSevenPointsWithRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        var leftEpipoleError = 0.0;
        var rightEpipoleError = 0.0;
        for (var j = 0; j < TIMES; j++) {
            ...
            final var estimator = new MSACFundamentalMatrixRobustEstimator(leftPointsWithError, rightPointsWithError,
                    this);
    ...
    @Test
    void testEstimateSevenPointsWithoutRefinement() throws LockedException, NotReadyException,
    ...
    private static void checkLocked(final MSACFundamentalMatrixRobustEstimator estimator) {
