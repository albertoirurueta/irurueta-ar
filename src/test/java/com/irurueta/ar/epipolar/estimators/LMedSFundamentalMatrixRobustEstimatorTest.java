...
class LMedSFundamentalMatrixRobustEstimatorTest implements FundamentalMatrixRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSFundamentalMatrixRobustEstimator();

        // check correctness
        assertEquals(LMedSFundamentalMatrixRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        ...
        estimator = new LMedSFundamentalMatrixRobustEstimator(leftPoints, rightPoints);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(emptyPoints, rightPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(leftPoints, emptyPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints));

        // test constructor with left and right points and listener
        estimator = new LMedSFundamentalMatrixRobustEstimator(leftPoints, rightPoints, this);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(emptyPoints, rightPoints, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(leftPoints, emptyPoints, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints, this));
    }
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        // set new value
        final var qualityScores = new double[0];
    ...
    void testEstimateSevenPointsWithRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            final var estimator = new LMedSFundamentalMatrixRobustEstimator(leftPointsWithError, rightPointsWithError,
                    this);
    ...
    void testEstimateEightPointsWithRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // estimate fundamental matrix
            final var estimator = new LMedSFundamentalMatrixRobustEstimator(
                    FundamentalMatrixEstimatorMethod.EIGHT_POINTS_ALGORITHM, leftPointsWithError, rightPointsWithError,
                    this);
            estimator.setStopThreshold(STOP_THRESHOLD);
            estimator.setResultRefined(true);
            estimator.setCovarianceKept(true);
    ...
    void testEstimateAffineWithRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // estimate fundamental matrix
            final var estimator = new LMedSFundamentalMatrixRobustEstimator(
                    FundamentalMatrixEstimatorMethod.AFFINE_ALGORITHM, leftPointsWithError, rightPointsWithError,
                    this);
            estimator.setStopThreshold(STOP_THRESHOLD);
            estimator.setResultRefined(true);
            estimator.setCovarianceKept(true);
    ...
    void testEstimateSevenPointsWithoutRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        // estimate fundamental matrix
        var estimator = new LMedSFundamentalMatrixRobustEstimator(leftPointsWithError, rightPointsWithError,
                this);
        estimator.setStopThreshold(STOP_THRESHOLD);
        ...
        // Force NotReadyException
        estimator = new LMedSFundamentalMatrixRobustEstimator();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
            ...
            for (final var leftPoint : leftPoints) {
                if (randomizer.nextInt(0, 100) < PERCENTAGE_OUTLIERS) {
                    ...
                    leftPointsWithError.add(new HomogeneousPoint2D(
                            leftPoint.getInhomX() + errorX, leftPoint.getInhomY() + errorY, 1.0));
                } else {
                    // inlier
                    leftPointsWithError.add(leftPoint);
                }
    ...
    public void onEstimateStart(final FundamentalMatrixRobustEstimator estimator) {
        estimateStart++;
        checkLocked((LMedSFundamentalMatrixRobustEstimator) estimator);
    }
    ...
    private static void checkLocked(final LMedSFundamentalMatrixRobustEstimator estimator) {
