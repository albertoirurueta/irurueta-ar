...
public class LMedSFundamentalMatrixRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        LMedSFundamentalMatrixRobustEstimator estimator = new LMedSFundamentalMatrixRobustEstimator();

        // check correctness
        assertEquals(LMedSFundamentalMatrixRobustEstimator.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(emptyPoints, rightPoints);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(leftPoints, emptyPoints);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(emptyPoints, rightPoints, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(leftPoints, emptyPoints, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSFundamentalMatrixRobustEstimator(emptyPoints, emptyPoints, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    private void checkLocked(final LMedSFundamentalMatrixRobustEstimator estimator) {
        try {
            estimator.setConfidence(0.5);
        ...
        } catch (final NotReadyException | RobustEstimatorException ignore) {
            fail("LockedException expected but not thrown");
        }
