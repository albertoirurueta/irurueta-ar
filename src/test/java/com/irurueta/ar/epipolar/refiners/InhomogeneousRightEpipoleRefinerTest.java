...
class InhomogeneousRightEpipoleRefinerTest implements RefinerListener<Point2D> {
    ...
    void testConstructor() throws GeometryException, AlgebraException, RobustEstimatorException {
        ...
        var refiner = new InhomogeneousRightEpipoleRefiner();
        ...
        refiner = new InhomogeneousRightEpipoleRefiner(rightEpipole, true, inliers, res, numInliers,
        ...
        refiner = new InhomogeneousRightEpipoleRefiner(rightEpipole, true, inliersData, samples1,
    ...
    void testGetSetListener() {
        final var refiner = new InhomogeneousRightEpipoleRefiner();
    ...
    void testRefine() throws GeometryException, AlgebraException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var refiner = new InhomogeneousRightEpipoleRefiner(noisyRightEpipole, true, inliers,
                    residuals, numPoints, samples1, samples2, ERROR_STD, homography);
            refiner.setListener(this);

            final var groundTruthResidual = refiner.totalResidual(groundTruthFundamentalMatrix);
    ...
    private static void checkLocked(final InhomogeneousRightEpipoleRefiner refiner) {
