...
class GoldStandardSingleCorrectorTest {
    ...
    void testConstructor() throws WrongSizeException, NotReadyException, LockedException, DecomposerException,
        ...
        var corrector = new GoldStandardSingleCorrector();
    ...
    void testGetSetPointsAndFundamentalMatrix() {
        final var corrector = new GoldStandardSingleCorrector();
    ...
    void testCorrect() throws InvalidPairOfCamerasException, com.irurueta.geometry.estimators.NotReadyException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var corrector = new GoldStandardSingleCorrector(wrongLeftPoint, wrongRightPoint, fundamentalMatrix);
