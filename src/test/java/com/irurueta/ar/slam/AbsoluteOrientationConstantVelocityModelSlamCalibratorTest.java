...
class AbsoluteOrientationConstantVelocityModelSlamCalibratorTest implements
    ...
    void testConstructor() throws WrongSizeException {
        final var calibrator = new AbsoluteOrientationConstantVelocityModelSlamCalibrator();
        ...
        final var controlMean = new double[AbsoluteOrientationConstantVelocityModelSlamEstimator.CONTROL_LENGTH];
        calibrator.getControlMean(controlMean);
        assertArrayEquals(new double[AbsoluteOrientationConstantVelocityModelSlamEstimator.CONTROL_LENGTH], controlMean,
                0.0);
    ...
    void testGetCalibrationData() {
        ...
        final var data2 = new AbsoluteOrientationConstantVelocityModelSlamCalibrationData();
    ...
    void testCalibrationWithOffset() throws SignalProcessingException {
        ...
        final var estimator = new MeasurementNoiseCovarianceEstimator(10);
        final var sample = new double[10];
        ...
        assertEquals(accelerationOffsetX / DELTA_SECONDS * 2.0, mean[4], VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(accelerationOffsetY / DELTA_SECONDS * 2.0, mean[5], VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(accelerationOffsetZ / DELTA_SECONDS * 2.0, mean[6], VERY_LARGE_ABSOLUTE_ERROR);
