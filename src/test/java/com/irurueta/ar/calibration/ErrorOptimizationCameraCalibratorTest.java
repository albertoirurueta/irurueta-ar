...
class ErrorOptimizationCameraCalibratorTest implements CameraCalibratorListener {
    ...
    void testConstructor() {
        ...
        var calibrator = new ErrorOptimizationCameraCalibrator();

        // check default values
        assertEquals(ErrorOptimizationCameraCalibrator.DEFAULT_LEVENBERG_MARQUARDT_MAX_ITERS,
                calibrator.getLevenbergMarquardtMaxIters());
        assertEquals(ErrorOptimizationCameraCalibrator.DEFAULT_LEVENBERG_MARQUARDT_TOLERANCE,
                calibrator.getLevenbergMarquardtTolerance(), 0.0);
        assertEquals(ErrorOptimizationCameraCalibrator.DEFAULT_RADIAL_DISTORTION_METHOD,
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new ErrorOptimizationCameraCalibrator(pattern, emptySamples));

        // test constructor with pattern, samples and quality scores
        final var samplesQualityScores = new double[1];
        calibrator = new ErrorOptimizationCameraCalibrator(pattern, samples, samplesQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new ErrorOptimizationCameraCalibrator(pattern, emptySamples,
                samplesQualityScores));
        assertThrows(IllegalArgumentException.class, () -> new ErrorOptimizationCameraCalibrator(pattern, samples,
                shortSamplesQualityScores));
    }

    @Test
    void testGetSetPattern() throws LockedException {
        final var calibrator = new ErrorOptimizationCameraCalibrator();
    ...
    void testGetSetFocalDistanceAspectRatio() throws LockedException {
        ...
        // check default value
        final var focalDistanceAspectRatio = calibrator.getFocalDistanceAspectRatio();
        assertEquals(focalDistanceAspectRatio, calibrator.getIACEstimator().getFocalDistanceAspectRatio(), 0.0);
    ...
    void testGetSetHomographyEstimatorThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(1.0, calibrator.getHomographyEstimatorThreshold(), 0.0);
        assertEquals(1.0, ((LMedSPointCorrespondenceProjectiveTransformation2DRobustEstimator) calibrator
    ...
    @Test
    void testGetSetLevenbergMarquardtMaxIters() throws LockedException {
        final var calibrator = new ErrorOptimizationCameraCalibrator();
        ...
        // check correctness
        assertEquals(1, calibrator.getLevenbergMarquardtMaxIters());

        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> calibrator.setLevenbergMarquardtMaxIters(0));
    }

    @Test
    void testGetSetLevenbergMarquardtTolerance() throws LockedException {
        final var calibrator = new ErrorOptimizationCameraCalibrator();
        ...
        // check correctness
        assertEquals(1.0, calibrator.getLevenbergMarquardtTolerance(), 0.0);

        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> calibrator.setLevenbergMarquardtTolerance(0.0));
    }
    ...
    void testGetSetDistortionEstimatorThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(3.0, calibrator.getDistortionEstimatorThreshold(), 0.0);
        assertEquals(3.0, ((PROSACRadialDistortionRobustEstimator) calibrator.
    ...
    void testCalibrateCirclesPatternNoDistortion() throws LockedException, CalibrationException, NotReadyException {
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // create calibrator
            final var calibrator = new ErrorOptimizationCameraCalibrator(pattern, samples);
            calibrator.setListener(this);
        ...
        Logger.getLogger(ErrorOptimizationCameraCalibratorTest.class.getName()).log(Level.INFO, msg);
    }
    ...
    void testCalibrateQRPatternNoDistortion() throws LockedException, CalibrationException, NotReadyException {
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            assertNotNull(calibrator.getEstimatedImageOfAbsoluteConic());
            assertNotNull(calibrator.getEstimatedIntrinsicParameters());
            var intrinsic2 = calibrator.getEstimatedIntrinsicParameters();
    ...
    @Test
    void testCalibrateCirclesPatternDistortion() throws LockedException, CalibrationException, NotReadyException,
        ...
        // check that average error of intrinsic parameters is small enough
        assertEquals(0.0, avgHorizontalFocalDistanceError, 6.0 * VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgVerticalFocalDistanceError, 6.0 * VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgSkewnessError, VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgHorizontalPrincipalPointError, VERY_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgVerticalPrincipalPointError, VERY_LARGE_ABSOLUTE_ERROR);
    ...
    @Test
    void testCalibrateCirclesPatternDistortionAndOutliers() throws LockedException, NotSupportedException,
            DistortionException {
    ...
    void testCalibrateQRPatternDistortionAndOutliers() throws LockedException, CalibrationException, NotReadyException,
        ...
        final String msg = "QR pattern - With distortion and outliers avg horizontal focal distance error: "
                + avgHorizontalFocalDistanceError
                + " avg vertical focal distance error: " + avgVerticalFocalDistanceError
                + " avg skewness error: " + avgSkewnessError
                + " avg horizontal principal point error: " + avgHorizontalPrincipalPointError
    ...
    @Test
    void testCalibrateMixedPatternDistortionAndOutliers() throws LockedException, CalibrationException,
    ...
    void testCalibrateRealData() throws LockedException, CalibrationException, NotReadyException {
        ...
        */
        ...
        final String msg = "Real data - focal length: " + horizontalFocalLength + "Distortion K1: " + k1 + " K2: " + k2;
        Logger.getLogger(AlternatingCameraCalibratorTest.class.getName()).log(Level.INFO, msg);
    }
    ...
    public void testLocked(final ErrorOptimizationCameraCalibrator calibrator) {
        assertThrows(LockedException.class, () -> calibrator.setLevenbergMarquardtMaxIters(1));
        assertThrows(LockedException.class, () -> calibrator.setLevenbergMarquardtTolerance(1.0));
