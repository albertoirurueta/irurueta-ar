...
class MSACRadialDistortionRobustEstimatorTest implements RadialDistortionRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRadialDistortionRobustEstimator();

        // check correctness
        assertEquals(MSACRadialDistortionRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        assertNull(estimator.getListener());
        assertFalse(estimator.isListenerAvailable());
        assertFalse(estimator.isLocked());
        assertEquals(MSACRadialDistortionRobustEstimator.DEFAULT_PROGRESS_DELTA, estimator.getProgressDelta(),
                0.0);
        assertEquals(MSACRadialDistortionRobustEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(), 0.0);
        assertEquals(MSACRadialDistortionRobustEstimator.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRadialDistortionRobustEstimator(emptyPoints, undistortedPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRadialDistortionRobustEstimator(emptyPoints, emptyPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRadialDistortionRobustEstimator(null, undistortedPoints));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRadialDistortionRobustEstimator(distortedPoints, null));

        // test constructor with points and listener
        estimator = new MSACRadialDistortionRobustEstimator(distortedPoints, undistortedPoints, this);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(emptyPoints,
                undistortedPoints, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(emptyPoints,
                emptyPoints, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(null,
                undistortedPoints, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(distortedPoints,
                null, this));
        ...
        estimator = new MSACRadialDistortionRobustEstimator(distortedPoints, undistortedPoints, center, this);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(null,
                undistortedPoints, center, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRadialDistortionRobustEstimator(
                distortedPoints, null, center, this));
    }

    @Test
    void testGetSetQualityScores() throws LockedException {
        final var estimator = new MSACRadialDistortionRobustEstimator();
    ...
    void testEstimate() throws NotSupportedException, LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            final var estimator = new MSACRadialDistortionRobustEstimator(distortedPointsWithError, undistortedPoints,
                    this);
