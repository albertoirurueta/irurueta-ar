...
class PROMedSDualAbsoluteQuadricRobustEstimatorTest implements DualAbsoluteQuadricRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSDualAbsoluteQuadricRobustEstimator();
        ...
        assertEquals(PROMedSDualAbsoluteQuadricRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSDualAbsoluteQuadricRobustEstimator(empty));
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSDualAbsoluteQuadricRobustEstimator(new double[1]));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSDualAbsoluteQuadricRobustEstimator(new double[1],
                this));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSDualAbsoluteQuadricRobustEstimator(empty,
                qualityScores));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSDualAbsoluteQuadricRobustEstimator(cameras,
                new double[1]));
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSDualAbsoluteQuadricRobustEstimator();
    ...
    void testEstimate() throws AlgebraException, InvalidTransformationException, LockedException, NotReadyException,
        ...
        var numSucceeded = 0;
        for (var times = 0; times < 10 * TIMES; times++) {
    ...
    private static void checkLocked(final DualAbsoluteQuadricRobustEstimator estimator) {
        ...
        final var promedsEstimator = (PROMedSDualAbsoluteQuadricRobustEstimator) estimator;
        assertThrows(LockedException.class, () -> promedsEstimator.setStopThreshold(1.0));
        assertThrows(LockedException.class, () -> promedsEstimator.setQualityScores(new double[2]));
        assertThrows(LockedException.class, () -> promedsEstimator.setZeroSkewness(true));
        assertThrows(LockedException.class, () -> promedsEstimator.setPrincipalPointAtOrigin(true));
        assertThrows(LockedException.class, () -> promedsEstimator.setFocalDistanceAspectRatioKnown(true));
        assertThrows(LockedException.class, () -> promedsEstimator.setFocalDistanceAspectRatio(2.0));
        assertThrows(LockedException.class, () -> promedsEstimator.setSingularityEnforced(true));
        assertThrows(LockedException.class, () -> promedsEstimator.setEnforcedSingularityValidated(true));
        assertThrows(LockedException.class, () -> promedsEstimator.setDeterminantThreshold(1e-3));
        assertThrows(LockedException.class, () -> promedsEstimator.setListener(null));
        assertThrows(LockedException.class, () -> promedsEstimator.setProgressDelta(0.1f));
        assertThrows(LockedException.class, () -> promedsEstimator.setConfidence(0.8));
        assertThrows(LockedException.class, () -> promedsEstimator.setMaxIterations(100));
        assertThrows(LockedException.class, () -> promedsEstimator.setCameras(null));
        assertThrows(LockedException.class, promedsEstimator::estimate);
    }
}
