...
public class PROMedSImageOfAbsoluteConicRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(PROMedSImageOfAbsoluteConicRobustEstimator.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(emptyHomographies);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(emptyScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = null;
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(emptyScores, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = null;
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(null, qualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(emptyHomographies, qualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSImageOfAbsoluteConicRobustEstimator(homographies, emptyScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final PROMedSImageOfAbsoluteConicRobustEstimator estimator =
                new PROMedSImageOfAbsoluteConicRobustEstimator();
    ...
    public void testEstimateRealData() throws CoincidentPointsException,
        ...
        */
        ...
        // estimate IAC
        final PROMedSImageOfAbsoluteConicRobustEstimator estimator =
                new PROMedSImageOfAbsoluteConicRobustEstimator(homographies, qualityScores, this);
        estimator.setZeroSkewness(true);
        estimator.setPrincipalPointAtOrigin(true);
