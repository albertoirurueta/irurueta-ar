...
class PROSACImageOfAbsoluteConicRobustEstimatorTest implements ImageOfAbsoluteConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACImageOfAbsoluteConicRobustEstimator();
        ...
        assertEquals(PROSACImageOfAbsoluteConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertFalse(estimator.isReady());
        assertNull(estimator.getQualityScores());
        assertEquals(RANSACImageOfAbsoluteConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.PROSAC, estimator.getMethod());

        // Force IllegalArgumentException
        final var emptyHomographies = new ArrayList<Transformation2D>();
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null));
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator(emptyHomographies));
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACImageOfAbsoluteConicRobustEstimator(emptyScores));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator(emptyScores, this));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator(null, qualityScores));
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator(emptyHomographies, qualityScores));
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACImageOfAbsoluteConicRobustEstimator(homographies, emptyScores));

        // test constructor with homographies, quality scores and listener
        estimator = new PROSACImageOfAbsoluteConicRobustEstimator(homographies, qualityScores, this);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACImageOfAbsoluteConicRobustEstimator(
                null, qualityScores, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACImageOfAbsoluteConicRobustEstimator(
                emptyHomographies, qualityScores, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACImageOfAbsoluteConicRobustEstimator(homographies,
                emptyScores, this));
    }
    ...
    void testGetSetHomographiesAndIsReady() throws LockedException {
        ...
        final var numHomographies = randomizer.nextInt(MIN_NUM_HOMOGRAPHIES, MAX_NUM_HOMOGRAPHIES);
    ...
    void testEstimateCirclesPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // Estimate IAC
            final var estimator = new PROSACImageOfAbsoluteConicRobustEstimator(homographies, qualityScores,
                    this);
    ...
    void testEstimateRealData() throws CoincidentPointsException, LockedException, NotReadyException,
        ...
        */
        ...
        // estimate IAC
        final var estimator = new PROSACImageOfAbsoluteConicRobustEstimator(homographies, qualityScores, this);
        estimator.setZeroSkewness(true);
        estimator.setPrincipalPointAtOrigin(true);
    ...
    private double homographyResidual(
            final ProjectiveTransformation2D homography, final Point2D inputPoint, final Point2D outputPoint) {
    ...
    private void testLocked(final PROSACImageOfAbsoluteConicRobustEstimator estimator) {
        ...
        assertThrows(LockedException.class, () -> estimator.setThreshold(1e-6));
