...
class MSACImageOfAbsoluteConicRobustEstimatorTest implements ImageOfAbsoluteConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new MSACImageOfAbsoluteConicRobustEstimator();
        ...
        assertEquals(MSACImageOfAbsoluteConicRobustEstimator.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACImageOfAbsoluteConicRobustEstimator(emptyHomographies));

        // test constructor with homographies and listener
        estimator = new MSACImageOfAbsoluteConicRobustEstimator(homographies, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACImageOfAbsoluteConicRobustEstimator();
    ...
    void testEstimateCirclesPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // Estimate IAC
            final var estimator = new MSACImageOfAbsoluteConicRobustEstimator(homographies, this);
        ...
        Logger.getLogger(MSACImageOfAbsoluteConicRobustEstimatorTest.class.getName()).log(Level.INFO, msg);
    ...
    void testEstimateQRPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        // check that average error of intrinsic parameters is small enough
        assertEquals(0.0, avgHorizontalFocalDistanceError, ULTRA_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgVerticalFocalDistanceError, ULTRA_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgSkewnessError, ULTRA_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgHorizontalPrincipalPointError, ULTRA_LARGE_ABSOLUTE_ERROR);
        assertEquals(0.0, avgVerticalPrincipalPointError, ULTRA_LARGE_ABSOLUTE_ERROR);
