...
public class RANSACImageOfAbsoluteConicRobustEstimatorTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new RANSACImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new RANSACImageOfAbsoluteConicRobustEstimator(emptyHomographies);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACImageOfAbsoluteConicRobustEstimator estimator =
                new RANSACImageOfAbsoluteConicRobustEstimator();
    ...
    public void testEstimateCirclesPattern() throws
        ...
        for (int j = 0; j < TIMES; j++) {
            ...
            for (int i = 0; i < nHomographies; i++) {
                ...
                final RANSACPointCorrespondenceProjectiveTransformation2DRobustEstimator
                        homographyEstimator = new RANSACPointCorrespondenceProjectiveTransformation2DRobustEstimator(
            ...
            // Estimate IAC
            RANSACImageOfAbsoluteConicRobustEstimator estimator =
                    new RANSACImageOfAbsoluteConicRobustEstimator(homographies, this);
