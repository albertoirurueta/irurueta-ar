...
class RANSACImageOfAbsoluteConicRobustEstimatorTest implements ImageOfAbsoluteConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACImageOfAbsoluteConicRobustEstimator();
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null));
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACImageOfAbsoluteConicRobustEstimator(emptyHomographies));

        // test constructor with homographies and listener
        estimator = new RANSACImageOfAbsoluteConicRobustEstimator(homographies, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACImageOfAbsoluteConicRobustEstimator();
    ...
    void testEstimateCirclesPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // Estimate IAC
            final var estimator = new RANSACImageOfAbsoluteConicRobustEstimator(homographies, this);
        ...
        Logger.getLogger(RANSACImageOfAbsoluteConicRobustEstimatorTest.class.getName()).log(Level.INFO, msg);
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            for (var i = 0; i < nHomographies; i++) {
                ...
                try {
                    ...
                    // if points are coincident, they cannot be used to estimate
    ...
    private void testLocked(final RANSACImageOfAbsoluteConicRobustEstimator estimator) {
