...
class LMedSImageOfAbsoluteConicRobustEstimatorTest implements ImageOfAbsoluteConicRobustEstimatorListener {
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSImageOfAbsoluteConicRobustEstimator();
        ...
        assertEquals(LMedSImageOfAbsoluteConicRobustEstimator.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSImageOfAbsoluteConicRobustEstimator((List<Transformation2D>) null));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSImageOfAbsoluteConicRobustEstimator(emptyHomographies));

        // test constructor with homographies and listener
        estimator = new LMedSImageOfAbsoluteConicRobustEstimator(homographies, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSImageOfAbsoluteConicRobustEstimator();
    ...
    void testEstimateCirclesPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            // Estimate IAC
            final var estimator = new LMedSImageOfAbsoluteConicRobustEstimator(homographies, this);
        ...
        Logger.getLogger(LMedSImageOfAbsoluteConicRobustEstimatorTest.class.getName()).log(Level.INFO, msg);
    ...
    void testEstimateQRPattern() throws InvalidPinholeCameraIntrinsicParametersException, LockedException,
        ...
        for (var j = 0; j < TIMES; j++) {
            ...
            for (var i = 0; i < nHomographies; i++) {
                ...
                try {
                    final var homography = new ProjectiveTransformation2D(patternPoints.get(0),
    ...
    private void testLocked(final LMedSImageOfAbsoluteConicRobustEstimator estimator) {
