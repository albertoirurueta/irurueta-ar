...
class LMedSRobustSinglePoint3DTriangulatorTest implements RobustSinglePoint3DTriangulatorListener {
    ...
    void testConstructor() {
        ...
        var triangulator = new LMedSRobustSinglePoint3DTriangulator();

        // check correctness
        assertEquals(LMedSRobustSinglePoint3DTriangulator.DEFAULT_STOP_THRESHOLD, triangulator.getStopThreshold(),
                0.0);
        ...
        assertEquals(LMedSRobustSinglePoint3DTriangulator.DEFAULT_PROGRESS_DELTA, triangulator.getProgressDelta(),
                0.0);
        assertEquals(LMedSRobustSinglePoint3DTriangulator.DEFAULT_CONFIDENCE, triangulator.getConfidence(), 0.0);
        assertEquals(LMedSRobustSinglePoint3DTriangulator.DEFAULT_MAX_ITERATIONS, triangulator.getMaxIterations());
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(emptyPoints, cameras));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(points, emptyCameras));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(emptyPoints, emptyCameras));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(emptyPoints, cameras, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(points, emptyCameras, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustSinglePoint3DTriangulator(emptyPoints, emptyCameras, this));
    }

    @Test
    void testGetSetStopThreshold() throws LockedException {
        final var triangulator = new LMedSRobustSinglePoint3DTriangulator();
    ...
    void testIsSetUseHomogeneousSolution() throws LockedException {
        ...
        // set new value
        triangulator.setUseHomogeneousSolution(!LMedSRobustSinglePoint3DTriangulator.DEFAULT_USE_HOMOGENEOUS_SOLUTION);
    ...
    void testTriangulate() throws LockedException, NotReadyException, RobustEstimatorException {
        for (var t = 0; t < TIMES; t++) {
            ...
            // create triangulator
            final var triangulator = new LMedSRobustSinglePoint3DTriangulator(points2D, cameras, this);
