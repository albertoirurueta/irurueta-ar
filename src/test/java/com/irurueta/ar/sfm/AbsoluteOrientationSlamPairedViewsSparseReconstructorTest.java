...
class AbsoluteOrientationSlamPairedViewsSparseReconstructorTest {
    ...
    void testConstructor() {
        assertEquals(2, AbsoluteOrientationSlamPairedViewsSparseReconstructor.MIN_NUMBER_OF_VIEWS);

        final var configuration = new AbsoluteOrientationSlamPairedViewsSparseReconstructorConfiguration();
        final var listener = new AbsoluteOrientationSlamPairedViewsSparseReconstructorListener() {
            @Override
            public void onSlamDataAvailable(
                    final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor,
            ...
            @Override
            public void onStart(final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onFinish(final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onCancel(final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onFail(final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor) {
                // no action needed
            }
        };

        var reconstructor = new AbsoluteOrientationSlamPairedViewsSparseReconstructor(listener);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseTwoViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var axisRotation2 = new AxisRotation3D(rotation1.inverseRotationAndReturnNew()
            ...
            var centralCommonPoint = new HomogeneousPoint3D(
                    v.getElementAt(0, 3),
                    v.getElementAt(1, 3),
                    v.getElementAt(2, 3),
                    v.getElementAt(3, 3));
            ...
            final var listener = new AbsoluteOrientationSlamPairedViewsSparseReconstructorListener() {
                ...
                @Override
                public void onFundamentalMatrixEstimated(
                        final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor, final int viewId1,
                        final int viewId2, final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    AbsoluteOrientationSlamPairedViewsSparseReconstructorTest.this.estimatedFundamentalMatrix =
                ...
                public void onEuclideanCameraPairEstimated(
                    ...
                    AbsoluteOrientationSlamPairedViewsSparseReconstructorTest.this.scale = scale;
                }
                ...
                @Override
                public PinholeCameraIntrinsicParameters onIntrinsicParametersRequested(
                        final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor, final int viewId) {
                    return intrinsic;
                }
            ...
            final var reconstructor = new AbsoluteOrientationSlamPairedViewsSparseReconstructor(configuration,
                    listener);
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new AbsoluteOrientationSlamPairedViewsSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        ...
                        final int viewId1, final int viewId2,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    AbsoluteOrientationSlamPairedViewsSparseReconstructorTest.this.estimatedFundamentalMatrix = estimatedFundamentalMatrix;
                }
            ...
            if (Math.abs(scale - estimatedBaseline) > LARGE_ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(scale, estimatedBaseline, LARGE_ABSOLUTE_ERROR);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseThreeViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new AbsoluteOrientationSlamPairedViewsSparseReconstructorListener() {
                ...
                @Override
                public void onFail(final AbsoluteOrientationSlamPairedViewsSparseReconstructor reconstructor) {
                    AbsoluteOrientationSlamPairedViewsSparseReconstructorTest.this.failed = true;
                }
            };
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithNoiseThreeViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var numInvalidPoints = 0;
            for (var i = 0; i < numPointsPair1; i++) {
                var p = euclideanReconstructedPoints3DPair1.get(i);
                if (estEuclideanCam1.isPointInFrontOfCamera(p)
                        && estEuclideanCam2.isPointInFrontOfCamera(p)
                        && estEuclideanCam3.isPointInFrontOfCamera(p)) {
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseFourViews()
        ...
        for (var t = 0; t < 3 * TIMES; t++) {
            ...
            final var estEuclideanCam2b = this.estimatedEuclideanCamera2b.getCamera();
            final var estEuclideanCam3 = this.estimatedEuclideanCamera3.getCamera();
            final var estEuclideanCam3b = this.estimatedEuclideanCamera3b.getCamera();
