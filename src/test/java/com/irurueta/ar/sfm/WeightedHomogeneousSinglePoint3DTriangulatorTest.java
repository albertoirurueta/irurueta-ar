...
class WeightedHomogeneousSinglePoint3DTriangulatorTest implements SinglePoint3DTriangulatorListener {
    ...
    void testConstructor() {
        ...
        var triangulator = new WeightedHomogeneousSinglePoint3DTriangulator();
        ...
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(emptyPoints,
                cameras));
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(points,
                emptyCameras));
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(emptyPoints,
                emptyCameras));
        ...
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(emptyPoints,
                cameras, weights));
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(points,
                emptyCameras, weights));
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(emptyPoints,
                emptyCameras, weights));
        assertThrows(IllegalArgumentException.class, () -> new WeightedHomogeneousSinglePoint3DTriangulator(points,
                cameras, emptyWeights));
        ...
        triangulator = new WeightedHomogeneousSinglePoint3DTriangulator(points, cameras, weights, this);
    ...
    void testGetSetPointsAndCameras() throws LockedException {
        final var triangulator = new WeightedHomogeneousSinglePoint3DTriangulator();
    ...
    void testGetSetPointsCamerasAndWeights() throws LockedException {
        ...
        final var emptyCameras = new ArrayList<PinholeCamera>();
        final var emptyWeights = new double[0];
        assertThrows(IllegalArgumentException.class, () -> triangulator.setPointsCamerasAndWeights(emptyPoints, cameras,
                weights));
        assertThrows(IllegalArgumentException.class, () -> triangulator.setPointsCamerasAndWeights(points, emptyCameras,
                weights));
        assertThrows(IllegalArgumentException.class, () -> triangulator.setPointsCamerasAndWeights(emptyPoints,
                emptyCameras, weights));
        assertThrows(IllegalArgumentException.class, () -> triangulator.setPointsCamerasAndWeights(points, cameras,
                emptyWeights));
    }
    ...
    void testTriangulate() throws LockedException, NotReadyException, Point3DTriangulationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            // create triangulator
            final var triangulator = new WeightedHomogeneousSinglePoint3DTriangulator(points2D, cameras, weights,
                    this);
    ...
    private void checkLocked(final WeightedHomogeneousSinglePoint3DTriangulator triangulator) {
