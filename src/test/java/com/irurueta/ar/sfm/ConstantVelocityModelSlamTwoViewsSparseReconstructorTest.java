...
class ConstantVelocityModelSlamTwoViewsSparseReconstructorTest {
    ...
    void testConstructor() {
        final var configuration = new ConstantVelocityModelSlamTwoViewsSparseReconstructorConfiguration();
        final var listener = new ConstantVelocityModelSlamTwoViewsSparseReconstructorListener() {
            @Override
            ...
            public void onRequestSamplesForCurrentView(
                    final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor, final int viewId,
            ...
            public void onCamerasEstimated(
                    final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor, final int viewId1,
            ...
            @Override
            public void onStart(final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onFinish(final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onCancel(final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor) {
                // no action needed
            }

            @Override
            public void onFail(final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor) {
                // no action needed
            }
        };

        // constructor with listener
        var reconstructor = new ConstantVelocityModelSlamTwoViewsSparseReconstructor(listener);
        ...
        reconstructor = new ConstantVelocityModelSlamTwoViewsSparseReconstructor(configuration, listener);
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new ConstantVelocityModelSlamTwoViewsSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final ConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    ConstantVelocityModelSlamTwoViewsSparseReconstructorTest.this.estimatedFundamentalMatrix =
            ...
            final var reconstructor = new ConstantVelocityModelSlamTwoViewsSparseReconstructor(configuration, listener);
