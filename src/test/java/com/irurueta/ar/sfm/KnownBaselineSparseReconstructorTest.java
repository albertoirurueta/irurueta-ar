...
class KnownBaselineSparseReconstructorTest {
    ...
    void testConstructor() {
        ...
        final var configuration = new KnownBaselineSparseReconstructorConfiguration();
        final var listener = new KnownBaselineSparseReconstructorListener() {
            @Override
            public boolean hasMoreViewsAvailable(final KnownBaselineSparseReconstructor reconstructor) {
                return false;
            }
        ...
        var reconstructor = new KnownBaselineSparseReconstructor(listener);
    ...
    void testGeneralPointsEssentialTwoViews() throws InvalidPairOfCamerasException, AlgebraException, CameraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var baseline = center1.distanceTo(center2);
            ...
            for (var i = 0; i < numPoints2; i++) {
                ...
                // heret 3D point is in front of both cameras
            ...
            final var listener = new KnownBaselineSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final KnownBaselineSparseReconstructor reconstructor,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    KnownBaselineSparseReconstructorTest.this.estimatedFundamentalMatrix = estimatedFundamentalMatrix;
                }
                ...
                public void onEuclideanCameraEstimated(
                    ...
                    KnownBaselineSparseReconstructorTest.this.scale = scale;
                }
            ...
            final var reconstructor = new KnownBaselineSparseReconstructor(configuration, listener);
            ...
            assertEquals(this.scale, baseline, LARGE_ABSOLUTE_ERROR);
            ...
            for (var i = 0; i < numPoints1; i++) {
                ...
                assertTrue(points3D1.get(i).equals(euclideanReconstructedPoints3D.get(i), LARGE_ABSOLUTE_ERROR));
            }
    ...
    void testGeneralPointsDIACTwoViews() throws InvalidPairOfCamerasException, AlgebraException, CameraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimatedBaseline = estimatedCenter1.distanceTo(estimatedCenter2);
            final var s = baseline / estimatedBaseline;
            assertEquals(this.scale, baseline, ABSOLUTE_ERROR);
    ...
    void testGeneralPointsDAQAndEssentialTwoViews() throws InvalidPairOfCamerasException, AlgebraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var aspectRatio = configuration.getInitialCamerasAspectRatio();
            final var skewness = 0.0;
            final var principalPointX = randomizer.nextDouble(
                    MIN_PRINCIPAL_POINT_ESSENTIAL, MAX_PRINCIPAL_POINT_ESSENTIAL);
            final var principalPointY = randomizer.nextDouble(
                    MIN_PRINCIPAL_POINT_ESSENTIAL, MAX_PRINCIPAL_POINT_ESSENTIAL);
            ...
            final var estimatedBaseline = estimatedCenter1.distanceTo(estimatedCenter2);
            final var s = baseline / estimatedBaseline;
            if (Math.abs(this.scale - baseline) > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(this.scale, baseline, ABSOLUTE_ERROR);
    ...
    @Test
    void testPlanarPointsEssentialTwoViews() throws InvalidPairOfCamerasException, AlgebraException,
            CameraException, com.irurueta.geometry.estimators.NotReadyException,
            com.irurueta.geometry.NotAvailableException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            assertTrue(euclideanRotation1.asInhomogeneousMatrix().equals(rotation1.asInhomogeneousMatrix(),
                    ABSOLUTE_ERROR));
            if (!euclideanRotation2.asInhomogeneousMatrix().equals(rotation2.asInhomogeneousMatrix(),
                    LARGE_ABSOLUTE_ERROR)) {
                continue;
            }
            assertTrue(euclideanRotation2.asInhomogeneousMatrix().equals(rotation2.asInhomogeneousMatrix(),
    ...
    void testPlanarPointsDAQTwoViews() throws InvalidPairOfCamerasException, AlgebraException, CameraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new KnownBaselineSparseReconstructorListener() {
                ...
                @Override
                public void onFail(final KnownBaselineSparseReconstructor reconstructor) {
                    KnownBaselineSparseReconstructorTest.this.failed = true;
                }
            };
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new KnownBaselineSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final KnownBaselineSparseReconstructor reconstructor,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    if (KnownBaselineSparseReconstructorTest.this.estimatedFundamentalMatrix == null) {
                        KnownBaselineSparseReconstructorTest.this.estimatedFundamentalMatrix = estimatedFundamentalMatrix;
            ...
            var numReconstructedPoints = numPoints1 - start + numPoints2;
            ...
            assertEquals(this.scale, baseline, ABSOLUTE_ERROR);
            if (Math.abs(scale2 - baseline) > ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(scale2, baseline, ABSOLUTE_ERROR);
            ...
            for (var i = start; i < numPoints1; i++) {
                ...
                if (!points3D1.get(i).equals(euclideanReconstructedPoints3D.get(i - start), LARGE_ABSOLUTE_ERROR)) {
                    validPoints = false;
                    break;
                }
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new KnownBaselineSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        ...
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    if (KnownBaselineSparseReconstructorTest.this.estimatedFundamentalMatrix == null) {
                        KnownBaselineSparseReconstructorTest.this.estimatedFundamentalMatrix
                ...
                @Override
                public void onMetricCameraEstimated(
                        final KnownBaselineSparseReconstructor reconstructor, final int previousViewId,
            ...
            final var s = baseline / estimatedBaseline;
            assertEquals(this.scale, baseline, LARGE_ABSOLUTE_ERROR);
            assertEquals(scale2, baseline, LARGE_ABSOLUTE_ERROR);
    ...
    void testGeneralPointsEssentialDLTThreeViews() throws InvalidPairOfCamerasException, AlgebraException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            assertEquals(scaledIntrinsic2.getHorizontalPrincipalPoint(), intrinsic.getHorizontalPrincipalPoint(),
                    ABSOLUTE_ERROR);
            assertEquals(scaledIntrinsic2.getVerticalPrincipalPoint(), intrinsic.getVerticalPrincipalPoint(), ABSOLUTE_ERROR);
