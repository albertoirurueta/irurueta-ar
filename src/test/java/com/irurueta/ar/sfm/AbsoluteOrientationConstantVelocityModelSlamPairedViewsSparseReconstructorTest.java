...
class AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorTest {
    ...
    // 0.02 seconds
    private static final int DELTA_NANOS = 20000000;
    ...
    void testConstructor() {
        assertEquals(2,
                AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor.MIN_NUMBER_OF_VIEWS);

        final var configuration =
                new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorConfiguration();
        final var listener = new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorListener() {
            @Override
            public void onSlamDataAvailable(
                    final AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor reconstructor,
                    ...
                    final double angularSpeedZ, Matrix covariance) {
                // no action needed
            }
            ...
            public void onRequestMatches(
                    final AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor reconstructor,
                    final int viewId1, final int viewId2, final List<Sample2D> samples1, final List<Sample2D> samples2,
            ...
            public void onFundamentalMatrixEstimated(
                    final AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor reconstructor,
                    final int viewId1, final int viewId2, final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                // no action needed
            }
            ...
            public void onEuclideanReconstructedPointsEstimated(
                    final AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor reconstructor,
                    final int viewId1, final int viewId2, final double scale, final List<ReconstructedPoint3D> points) {
                // no action needed
            }
        ...
        var reconstructor = new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor(listener);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseTwoViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener =
                    new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorListener() {
                        ...
                        public void onFundamentalMatrixEstimated(
                            ...
                            AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorTest.this.estimatedFundamentalMatrix
                        ...
                        public void onEuclideanCameraPairEstimated(
                            ...
                            AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorTest.this.scale =
                                    scale;
                        }
            ...
            final var reconstructor = new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor(
            ...
            assertEquals(reconstructor.getCurrentScale(), scale, 0.0);
            ...
            if (!fundamentalMatrix.getInternalMatrix().equals(estimatedFundamentalMatrix.getFundamentalMatrix()
            ...
            final var estEuclideanCam1 = estimatedEuclideanCamera1.getCamera();
            final var estEuclideanCam2 = estimatedEuclideanCamera2.getCamera();
            ...
            var scaleRelativeError = Math.abs(baseline / scale - 1.0);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithNoiseTwoViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener =
                    new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorListener() {
                        ...
                        public void onFundamentalMatrixEstimated(
                                ...
                                final int viewId1, final int viewId2,
                                final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                            AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorTest.this
            ...
            // matrices are equal up to scale
            if (!fundamentalMatrix.getInternalMatrix().equals(estimatedFundamentalMatrix.getFundamentalMatrix()
                    .getInternalMatrix(), ABSOLUTE_ERROR) && !fundamentalMatrix.getInternalMatrix()
                    .multiplyByScalarAndReturnNew(-1).equals(estimatedFundamentalMatrix.getFundamentalMatrix()
                            .getInternalMatrix(), ABSOLUTE_ERROR)) {
                continue;
            }
            assertTrue(fundamentalMatrix.getInternalMatrix().equals(
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseThreeViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorListener() {
                ...
                public void onFail(
                        final AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructor reconstructor) {
                    AbsoluteOrientationConstantVelocityModelSlamPairedViewsSparseReconstructorTest.this.failed = true;
                }
            };
            ...
            assertTrue(fundamentalMatrix.getInternalMatrix().equals(estimatedFundamentalMatrix
                    .getFundamentalMatrix().getInternalMatrix(), ABSOLUTE_ERROR)
                    || fundamentalMatrix.getInternalMatrix().multiplyByScalarAndReturnNew(-1).equals(
                    estimatedFundamentalMatrix.getFundamentalMatrix().getInternalMatrix(), ABSOLUTE_ERROR));
            if (!fundamentalMatrix2.getInternalMatrix().equals(estimatedFundamentalMatrix2.getFundamentalMatrix()
                    .getInternalMatrix(), ABSOLUTE_ERROR) && !fundamentalMatrix2.getInternalMatrix()
                    .multiplyByScalarAndReturnNew(-1).equals(estimatedFundamentalMatrix2.getFundamentalMatrix()
                            .getInternalMatrix(), ABSOLUTE_ERROR)) {
                continue;
            }
            assertTrue(fundamentalMatrix2.getInternalMatrix().equals(estimatedFundamentalMatrix2
                    .getFundamentalMatrix().getInternalMatrix(), ABSOLUTE_ERROR)
            ...
            final var estEuclideanCam1 = estimatedEuclideanCamera1.getCamera();
            final var estEuclideanCam2 = estimatedEuclideanCamera2.getCamera();
            final var estEuclideanCam2b = estimatedEuclideanCamera2b.getCamera();
            final var estEuclideanCam3 = estimatedEuclideanCamera3.getCamera();
            ...
            final var scaleTransformation = new MetricTransformation3D(scale);
            final var scaleTransformation2 = new MetricTransformation3D(scale2);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseFourViews()
        ...
        for (var t = 0; t < 3 * TIMES; t++) {
            ...
            assertTrue(fundamentalMatrix2.getInternalMatrix().equals(
                    ...
                    || fundamentalMatrix2.getInternalMatrix().multiplyByScalarAndReturnNew(-1).equals(
                            estimatedFundamentalMatrix2.getFundamentalMatrix().getInternalMatrix(), ABSOLUTE_ERROR));
            if (!fundamentalMatrix3.getInternalMatrix().equals(estimatedFundamentalMatrix3.getFundamentalMatrix()
                            .getInternalMatrix(), ABSOLUTE_ERROR) && !fundamentalMatrix3.getInternalMatrix()
                    .multiplyByScalarAndReturnNew(-1).equals(estimatedFundamentalMatrix3.getFundamentalMatrix()
                                    .getInternalMatrix(), ABSOLUTE_ERROR)) {
                continue;
            }
            ...
            var estEuclideanCam1 = estimatedEuclideanCamera1.getCamera();
            var estEuclideanCam2 = estimatedEuclideanCamera2.getCamera();
            var estEuclideanCa2b = estimatedEuclideanCamera2b.getCamera();
            var estEuclideanCam3 = estimatedEuclideanCamera3.getCamera();
            var estEuclideanCam3b = estimatedEuclideanCamera3b.getCamera();
            var estEuclideanCam4 = estimatedEuclideanCamera4.getCamera();

            estEuclideanCam1.decompose();
            estEuclideanCam2.decompose();
            estEuclideanCa2b.decompose();
            estEuclideanCam3.decompose();
            ...
            for (var i = 0; i < numPointsPair2; i++) {
                ...
                if (estEuclideanCam1.isPointInFrontOfCamera(p)
                        && estEuclideanCam2.isPointInFrontOfCamera(p)
                        && estEuclideanCa2b.isPointInFrontOfCamera(p)
                        && estEuclideanCam3.isPointInFrontOfCamera(p)) {

                    assertTrue(estEuclideanCam1.isPointInFrontOfCamera(p));
                    assertTrue(estEuclideanCam2.isPointInFrontOfCamera(p));
                    assertTrue(estEuclideanCa2b.isPointInFrontOfCamera(p));
                    assertTrue(estEuclideanCam3.isPointInFrontOfCamera(p));
            ...
            final var euclideanIntrinsic1 = estEuclideanCam1.getIntrinsicParameters();
            final var euclideanIntrinsic2 = estEuclideanCam2.getIntrinsicParameters();
            final var euclideanIntrinsic2b = estEuclideanCa2b.getIntrinsicParameters();
            final var euclideanIntrinsic3 = estEuclideanCam3.getIntrinsicParameters();
            ...
            final var euclideanRotation1 = estEuclideanCam1.getCameraRotation();
            final var euclideanRotation2 = estEuclideanCam2.getCameraRotation();
            final var euclideanRotation2b = estEuclideanCa2b.getCameraRotation();
            final var euclideanRotation3 = estEuclideanCam3.getCameraRotation();
            ...
            final var scaleTransformation = new MetricTransformation3D(scale);
            final var scaleTransformation2 = new MetricTransformation3D(scale2);
            final var scaleTransformation3 = new MetricTransformation3D(scale3);
    ...
    private static AbsoluteOrientationConstantVelocityModelSlamCalibrator createFinishedCalibrator(
        ...
        var t = System.currentTimeMillis() * MILLIS_TO_NANOS;
        ...
        for (var i = 0; i < MAX_CALIBRATION_SAMPLES; i++) {
            ...
            calibrator.updateAccelerometerSample(t, (float) accelerationX, (float) accelerationY,
                    (float) accelerationZ);
            calibrator.updateGyroscopeSample(t, (float) angularX, (float) angularY, (float) angularZ);
            calibrator.updateOrientationSample(t, orientation);
