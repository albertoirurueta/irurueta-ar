...
class SlamPairedViewsSparseReconstructorTest {
    ...
    void testConstructor() {
        ...
        final var configuration = new SlamPairedViewsSparseReconstructorConfiguration();
        final var listener = new SlamPairedViewsSparseReconstructorListener() {
            @Override
            ...
            @Override
            public boolean hasMoreViewsAvailable(final SlamPairedViewsSparseReconstructor reconstructor) {
                return false;
            }

            @Override
            public void onRequestSamplesForCurrentViewPair(
                    final SlamPairedViewsSparseReconstructor reconstructor, final int viewId1, final int viewId2,
        ...
        var reconstructor = new SlamPairedViewsSparseReconstructor(listener);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseTwoViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new SlamPairedViewsSparseReconstructorListener() {
                ...
                @Override
                public void onSlamCameraEstimated(
                        final SlamPairedViewsSparseReconstructor reconstructor, final PinholeCamera camera) {
                    slamCameraEstimated++;
                    slamCamera = camera;
                }
                ...
                public void onFundamentalMatrixEstimated(
                        final SlamPairedViewsSparseReconstructor reconstructor, final int viewId1, final int viewId2,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    SlamPairedViewsSparseReconstructorTest.this.estimatedFundamentalMatrix = estimatedFundamentalMatrix;
                }
                ...
                public void onEuclideanCameraPairEstimated(
                    ...
                    SlamPairedViewsSparseReconstructorTest.this.scale = scale;
                }
            ...
            final var reconstructor = new SlamPairedViewsSparseReconstructor(configuration, listener);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseThreeViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new SlamPairedViewsSparseReconstructorListener() {
                ...
                public void onEuclideanCameraPairEstimated(
                        final SlamPairedViewsSparseReconstructor reconstructor, final int viewId1, final int viewId2,
                        double scale, final EstimatedCamera camera1, final EstimatedCamera camera2) {
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithNoiseThreeViews()
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var scaleRelativeError2 = Math.abs(baseline2 / scale2 - 1.0);
            LOGGER.log(Level.INFO, "Baseline relative error without noise 1: {0,number,0.000%}",
                    scaleRelativeError);
            LOGGER.log(Level.INFO, "Baseline relative error without noise 2: {0,number,0.000%}",
                    scaleRelativeError2);
    ...
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseFourViews()
        ...
        for (var t = 0; t < 3 * TIMES; t++) {
            ...
            // check that rotations created by composing sensor samples are equal
            // to the original one
            assertTrue(rotation3.equals(rotation3b, 6.0 * ABSOLUTE_ERROR));
            assertTrue(rotation3.equals(rotation3c, 6.0 * ABSOLUTE_ERROR));
            ...
            final var listener = new SlamPairedViewsSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final SlamPairedViewsSparseReconstructor reconstructor, final int viewId1, final int viewId2,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    var vCount = reconstructor.getViewCount();
                    if (vCount == 0) {
                        SlamPairedViewsSparseReconstructorTest.this.estimatedFundamentalMatrix =
                ...
                @Override
                public void onFail(final SlamPairedViewsSparseReconstructor reconstructor) {
                    SlamPairedViewsSparseReconstructorTest.this.failed = true;
                }
            };
            ...
            assertEquals(euclideanBaseline2, baseline2, absoluteScaleError2);
            if (Math.abs(scale2 - euclideanBaseline2) > 10 * LARGE_ABSOLUTE_ERROR) {
                continue;
            }
            assertEquals(scale2, euclideanBaseline2, 10 * LARGE_ABSOLUTE_ERROR);
            ...
            if (Math.abs(scale3 - euclideanBaseline3) > 20 * LARGE_ABSOLUTE_ERROR) {
                continue;
            }
    ...
    @Test
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithoutNoiseTwoViews2()
            throws InvalidPairOfCamerasException, AlgebraException, CameraException, RotationException,
            com.irurueta.geometry.estimators.NotReadyException, com.irurueta.geometry.NotAvailableException {
    ...
    @Test
    void testGeneralPointsEssentialWithConstantAccelerationAndRotationWithNoiseTwoViews2()
            throws InvalidPairOfCamerasException, AlgebraException, CameraException, RotationException,
            com.irurueta.geometry.estimators.NotReadyException, com.irurueta.geometry.NotAvailableException {
