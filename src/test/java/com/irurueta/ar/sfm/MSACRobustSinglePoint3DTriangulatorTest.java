...
class MSACRobustSinglePoint3DTriangulatorTest implements RobustSinglePoint3DTriangulatorListener {
    ...
    void testConstructor() {
        ...
        var triangulator = new MSACRobustSinglePoint3DTriangulator();

        // check correctness
        assertEquals(MSACRobustSinglePoint3DTriangulator.DEFAULT_THRESHOLD, triangulator.getThreshold(), 0.0);
        ...
        assertEquals(MSACRobustSinglePoint3DTriangulator.DEFAULT_PROGRESS_DELTA, triangulator.getProgressDelta(),
                0.0);
        assertEquals(MSACRobustSinglePoint3DTriangulator.DEFAULT_CONFIDENCE, triangulator.getConfidence(), 0.0);
        assertEquals(MSACRobustSinglePoint3DTriangulator.DEFAULT_MAX_ITERATIONS, triangulator.getMaxIterations());
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(emptyPoints, cameras));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(points, emptyCameras));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(emptyPoints, emptyCameras));
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(emptyPoints, cameras, this));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(points, emptyCameras, this));
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustSinglePoint3DTriangulator(emptyPoints, emptyCameras, this));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var triangulator = new MSACRobustSinglePoint3DTriangulator();
    ...
    void testIsSetUseHomogeneousSolution() throws LockedException {
        ...
        // set new value
        triangulator.setUseHomogeneousSolution(!MSACRobustSinglePoint3DTriangulator.DEFAULT_USE_HOMOGENEOUS_SOLUTION);
    ...
    void testTriangulate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            // create triangulator
            final var triangulator = new MSACRobustSinglePoint3DTriangulator(points2D, cameras, this);
