...
class TwoViewsSparseReconstructorTest {
    ...
    void testConstructor() {
        final var configuration = new TwoViewsSparseReconstructorConfiguration();
        final var listener = new TwoViewsSparseReconstructorListener() {
            ...
            public void onRequestSamplesForCurrentView(
                    final TwoViewsSparseReconstructor reconstructor, final int viewId, final List<Sample2D> samples) {
                // no action needed
            }
            ...
            public void onRequestMatches(
                    final TwoViewsSparseReconstructor reconstructor, final List<Sample2D> samples1,
            ...
            public void onCamerasEstimated(
                    final TwoViewsSparseReconstructor reconstructor, final int viewId1, final int viewId2,
        ...
        var reconstructor = new TwoViewsSparseReconstructor(listener);
    ...
    @Test
    void testGeneralPointsEssential() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new TwoViewsSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final TwoViewsSparseReconstructor reconstructor,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    TwoViewsSparseReconstructorTest.this.estimatedFundamentalMatrix = estimatedFundamentalMatrix;
                }
            ...
            final var reconstructor = new TwoViewsSparseReconstructor(configuration, listener);
            ...
            final var scaledCamera1 = scaleTransformation.transformAndReturnNew(estCam1);
            final var scaledCamera2 = scaleTransformation.transformAndReturnNew(estCam2);
    ...
    @Test
    void testGeneralPointsDIAC() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
        var numValid = 0;
        for (var t = 0; t < TIMES; t++) {
            final var configuration = new TwoViewsSparseReconstructorConfiguration();
    ...
    @Test
    void testGeneralPointsDAQAndEssential() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
        var numValid = 0;
        for (var t = 0; t < TIMES; t++) {
            final var configuration = new TwoViewsSparseReconstructorConfiguration();
    ...
    @Test
    void testGeneralPointsDAQ() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, LockedException, RobustEstimatorException, AlgebraException {
    ...
    @Test
    void testPlanarPointsEssential() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
    ...
    @Test
    void testPlanarPointsDIAC() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
        var numValid = 0;
        for (var t = 0; t < TIMES; t++) {
            final var configuration = new TwoViewsSparseReconstructorConfiguration();
    ...
    @Test
    void testPlanarPointsDAQAndEssential() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new TwoViewsSparseReconstructorListener() {
                ...
                @Override
                public void onFail(final TwoViewsSparseReconstructor reconstructor) {
                    TwoViewsSparseReconstructorTest.this.failed = true;
                }
            };
    ...
    @Test
    void testPlanarPointsDAQ() throws InvalidPairOfCamerasException, CameraException, NotReadyException,
            NotAvailableException, AlgebraException {
