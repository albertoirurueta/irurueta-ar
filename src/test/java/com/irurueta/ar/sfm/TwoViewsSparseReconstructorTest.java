...
public class TwoViewsSparseReconstructorTest {
    ...
    public void testConstructor() {
        ...
        final TwoViewsSparseReconstructorListener listener = new TwoViewsSparseReconstructorListener() {

            @Override
            public boolean hasMoreViewsAvailable(final TwoViewsSparseReconstructor reconstructor) {
                return false;
            }

            @Override
            public void onRequestSamplesForCurrentView(
                    final TwoViewsSparseReconstructor reconstructor, final int viewId,
            ...
            public void onRequestMatches(
                    final TwoViewsSparseReconstructor reconstructor,
            ...
            public void onCamerasEstimated(
                    final TwoViewsSparseReconstructor reconstructor, final int viewId1,
                    final int viewId2, final EstimatedCamera camera1,
            ...
            @Override
            public void onStart(final TwoViewsSparseReconstructor reconstructor) {
            }

            @Override
            public void onFinish(final TwoViewsSparseReconstructor reconstructor) {
            }

            @Override
            public void onCancel(final TwoViewsSparseReconstructor reconstructor) {
            }

            @Override
            public void onFail(final TwoViewsSparseReconstructor reconstructor) {
            }
        };

        // constructor with listener
        TwoViewsSparseReconstructor reconstructor = new TwoViewsSparseReconstructor(listener);
        ...
        reconstructor = new TwoViewsSparseReconstructor(configuration, listener);
    ...
    @Test
    public void testGeneralPointsEssential() throws InvalidPairOfCamerasException, CameraException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PinholeCamera scaledCamera1 = scaleTransformation.transformAndReturnNew(estimatedCamera1);
            final PinholeCamera scaledCamera2 = scaleTransformation.transformAndReturnNew(estimatedCamera2);
            ...
            for (int i = 0; i < numPoints; i++) {
                if (!points3D.get(i).equals(scaledReconstructionPoints3D.get(i), LARGE_ABSOLUTE_ERROR)) {
                    validPoints = false;
                    break;
                }
                assertTrue(points3D.get(i).equals(scaledReconstructionPoints3D.get(i), LARGE_ABSOLUTE_ERROR));
            }
    ...
    @Test
    public void testGeneralPointsDIAC() throws InvalidPairOfCamerasException, CameraException,
            NotReadyException, NotAvailableException, AlgebraException {
        int numValid = 0;
        for (int t = 0; t < TIMES; t++) {
            final TwoViewsSparseReconstructorConfiguration configuration =
            ...
            final TwoViewsSparseReconstructorListener listener = new TwoViewsSparseReconstructorListener() {
                ...
                @Override
                public void onReconstructedPointsEstimated(
                        final TwoViewsSparseReconstructor reconstructor, final List<MatchedSamples> matches,
                        final List<ReconstructedPoint3D> points) {
                    mReconstructedPoints = points;
                }
    ...
    @Test
    public void testGeneralPointsDAQAndEssentialZeroPrincipalPoint() throws InvalidPairOfCamerasException,
    ...
    public void testGeneralPointsDAQ() throws InvalidPairOfCamerasException, CameraException,
            NotReadyException, NotAvailableException, LockedException, RobustEstimatorException,
            AlgebraException {
    ...
    @Test
    public void testPlanarPointsDIAC() throws InvalidPairOfCamerasException, CameraException,
            NotReadyException, NotAvailableException, AlgebraException {
        int numValid = 0;
        for (int t = 0; t < TIMES; t++) {
            final TwoViewsSparseReconstructorConfiguration configuration =
    ...
    @Test
    public void testPlanarPointsDAQAndEssentialZeroPrincipalPoint() throws InvalidPairOfCamerasException,
            CameraException, NotReadyException, NotAvailableException, AlgebraException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final TwoViewsSparseReconstructorListener listener = new TwoViewsSparseReconstructorListener() {
                ...
                public void onCamerasEstimated(
                        final TwoViewsSparseReconstructor reconstructor, final int viewId1,
                        final int viewId2, EstimatedCamera camera1, final EstimatedCamera camera2) {
                    mEstimatedCamera1 = camera1;
                    mEstimatedCamera2 = camera2;
                }
            ...
            final List<Point3D> scaledReconstructionPoints3D =
                    scaleTransformation.transformPointsAndReturnNew(reconstructedPoints3D);
    ...
    @Test
    public void testPlanarPointsDAQAndEssential() throws InvalidPairOfCamerasException,
            CameraException, NotReadyException, NotAvailableException, AlgebraException {
