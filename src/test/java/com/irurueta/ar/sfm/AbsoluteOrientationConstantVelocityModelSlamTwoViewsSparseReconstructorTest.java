...
class AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructorTest {
    ...
    void testConstructor() {
        ...
        final var listener = new AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructorListener() {
            @Override
            public void onSlamDataAvailable(
                    final AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor,
        ...
        var reconstructor = new AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructor(listener);
        ...
        reconstructor = new AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructor(configuration,
                listener);
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var listener = new AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructorListener() {
                ...
                public void onFundamentalMatrixEstimated(
                        final AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructor reconstructor,
                        final EstimatedFundamentalMatrix estimatedFundamentalMatrix) {
                    AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructorTest.this
            ...
            final var reconstructor = new AbsoluteOrientationConstantVelocityModelSlamTwoViewsSparseReconstructor(
